...
brittleRegion = newv;
Box(brittleRegion) = {-width/2,yc-hBrittleB,-depth,wBrittle,hBrittleB+hBrittleT,depth};
...
Field[1].YMin      = -hBrittleB+yc;
Field[1].YMax      =  hBrittleT+yc;
Field[1].ZMin      =  -depth;
Field[1].ZMax      =  0;
Field[1].VIn       =  hf;
Field[1].VOut      =  hc;
Field[1].Thickness =  hBrittleB+hBrittleT;
