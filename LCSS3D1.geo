...
out[] = BooleanFragments{ Volume{elasticRegion}; Delete; }{ Volume{brittleRegion};  Delete; };
...
lcrackBegin = newp;
Point(lcrackBegin) = {-width/2,0,-depth};
lcrackEnd = newp;
Point(lcrackEnd) = {-width/2+lcrack,0,-depth};
logicalCrackL = newl;
...
//Printf("out[2] %g",out[2]);
logicalCrackS = out[1];
out = BooleanFragments{ Volume{brittleRegion}; Delete; }{ Surface{logicalCrackS}; Delete; };
