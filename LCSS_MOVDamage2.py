...
def plot(options):
    ...
    cmd = 'ffmpeg -y -i {framesDir}/{prefix}-%04d-disp{displacementScaling:.2f}.png -f mp4 -vcodec h264 -pix_fmt yuv420p  {movName}.mp4'.format(framesDir=framesDir,prefix=prefix,movName=movName,**options.__dict__)
